...
const features = [
  {
    ...
    text: "Забудь про перемикання між банківськими додатками. Ми збираємо твій баланс, Burn Rate та чистий прибуток в єдиний пазл.",
    bullets: [
      {
        icon: Clock,
        title: "Cash Runway",
  ...
  },
  {
    ...
    text: "Клієнт заплатив багато, але чи ти заробив? Система автоматично віднімає витрати на софт та зарплати команди від бюджету проекту.",
    bullets: [
      {
        icon: BarChart2,
  ...
  },
  {
    ...
    heading: "Скільки коштує твоя команда щохвилини?",
  ...
  },
  {
    ...
    heading: "Передбачай майбутнє, а не розгрібай наслідки.",
