        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-muted-foreground">
              {tab === "signup"
                ? "14 днів безкоштовно, без карки."
                : "Залітай в свій дашборд."}
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 bg-primary text-white font-semibold text-sm py-3.5 rounded-xl hover:bg-blue-700 transition-colors duration-200 mt-2"
            >
          ...
          <p className="text-xs text-muted-foreground text-center mt-6">
            {tab === "signup"
              ? "Реєструючись, ти погоджуєшся з нашою "
              : "Ще немає акаунту? "}
            {tab === "signup" ? (
